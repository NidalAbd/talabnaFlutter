...
class _LanguageThemeSelectorState extends State<LanguageThemeSelector> {
  ...
  Future<void> _handleThemeChange() async {
    ...
    if (isDarkMode) {
      ...
      AppTheme.setSystemBarColors(Brightness.light, AppTheme.lightPrimaryColor,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Text(
            selectedLanguage ==
                    'ar' // Use the state variable instead of _language.getLanguage()
                ? 'تم تغيير اللغة'
                : 'Language Changed',
          ...
          actions: <Widget>[
            ElevatedButton(
              onPressed: () async {
                ...
                print(
                    "SharedPreferences language: ${prefs.getString('language')}");
