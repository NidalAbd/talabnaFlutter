...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    // Changed to pure white for consistency
    cardColor: Colors.white,
    dialogBackgroundColor: lightBackgroundColor,
    dividerColor: Colors.grey.shade200,
    appBarTheme: const AppBarTheme(
      color: Colors.white,
      // Pure white for AppBar
      elevation: 0,
    ...
    textTheme: const TextTheme(
      ...
      displayMedium: TextStyle(
          fontSize: 26, fontWeight: FontWeight.bold, color: lightTextColor),
      ...
      titleMedium: TextStyle(
          fontSize: 16, fontWeight: FontWeight.bold, color: lightTextColor),
