...
import 'package:talabna/blocs/other_users/user_profile_event.dart';
import 'package:talabna/blocs/other_users/user_profile_state.dart';
  ...
  OtherUserProfileBloc({required UserProfileRepository repository})
    ...
    on<OtherUserFollowerRequested>((event, emit) async {
      ...
      try {
        ...
        emit(OtherUserFollowerFollowingSuccess(
