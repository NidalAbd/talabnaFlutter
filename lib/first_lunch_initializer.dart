...
class FirstLaunchInitializer {
  ...
  Future<void> initializeWithCacheClear() async {
    ...
    */
      ...
      DebugLogger.log('Error in cache initialization: $e',
          category: 'INIT_ERROR');
    }
  }
  ...
  Future<void> initializeAppData() async {
    try {
      ...
      await prefs.setInt('last_initialization_timestamp',
  ...
  Future<void> _initializeCategories() async {
    try {
      ...
      DebugLogger.log(
          'Fetched ${categories.length} categories during initialization',
          category: 'INIT');
    } catch (e) {
  ...
  Future<void> _initializeCategoryMenu() async {
    try {
      ...
      DebugLogger.log(
          'Fetched ${categoryMenu.length} category menu items during initialization',
          category: 'INIT');
    } catch (e) {
      DebugLogger.log('Failed to fetch category menu: $e',
          category: 'INIT_ERROR');
      rethrow;
    }
  }
  ...
  Future<void> _initializeDefaultCategoryPosts() async {
    try {
      ...
      final servicePosts = await servicePostRepository
          .getServicePostsByCategory(categories: defaultCategory, page: 1);
      DebugLogger.log(
          'Fetched ${servicePosts.length} service posts for category $defaultCategory during initialization',
          category: 'INIT');
    } catch (e) {
      DebugLogger.log('Failed to fetch default category service posts: $e',
          category: 'INIT_ERROR');
      rethrow;
    }
  }
  ...
  Future<void> _initializeDefaultCategorySubcategories() async {
    try {
      ...
      DebugLogger.log('Failed to fetch default category subcategories: $e',
          category: 'INIT_ERROR');
      rethrow;
    }
  }
