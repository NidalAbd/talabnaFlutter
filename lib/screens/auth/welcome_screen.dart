...
class _WelcomeScreenState extends State<WelcomeScreen>
  ...
  Future<void> _handleThemeChange() async {
    ...
    if (context.mounted) {
      if (newMode) {
        ...
        AppTheme.setSystemBarColors(Brightness.dark, AppTheme.darkPrimaryColor,
            AppTheme.darkPrimaryColor);
      } else {
        context.read<ThemeCubit>().emit(AppTheme.lightTheme);
        AppTheme.setSystemBarColors(Brightness.light,
            AppTheme.lightPrimaryColor, AppTheme.lightPrimaryColor);
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    AppTheme.setSystemBarColors(isDarkMode ? Brightness.light : Brightness.dark,
      ...
      child: Column(
        children: [
          ...
          _buildLanguageOption(
              'ar', 'العربية', 'Arabic', isDarkMode, primaryColor),
          const SizedBox(height: 16),
          _buildLanguageOption(
              'en', 'English', 'الإنجليزية', isDarkMode, primaryColor),
  ...
  Widget _buildLanguageOption(String langCode, String primaryText,
      String secondaryText, bool isDarkMode, Color primaryColor) {
