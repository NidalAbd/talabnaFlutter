...
class _LoginScreenNewState extends State<LoginScreenNew> {
  static int _instanceCount =
      0; // Track how many times LoginScreenNew is created
  static int _buildCount = 0; // Track how many times build() is called
  ...
  void initState() {
    super.initState();
    _instanceCount++; // Increment instance count on creation
    language.getLanguage();
    debugPrint(
        '[LOGIN] LoginScreenNew instance created ($_instanceCount times)');
  }

  @override
  Widget build(BuildContext context) {
    _buildCount++; // Increment build count each time the screen rebuilds
    debugPrint(
        '[LOGIN] LoginScreenNew build method called ($_buildCount times)');
      ...
      listener: (context, state) {
        if (state is AuthenticationInProgress) {
          ...
          if (!_hasNavigated) {
            ...
            // Use a microtask to ensure UI updates complete first
            Future.microtask(() {
