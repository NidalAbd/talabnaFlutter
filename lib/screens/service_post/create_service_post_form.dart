...
import 'package:talabna/utils/functions.dart';
...
class _ServicePostFormScreenState extends State<ServicePostFormScreen> {
  ...
  void initState() {
    ...
    _priceController =
        TextEditingController(text: (_formData['price'] ?? 0).toString());
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
              ...
              child: Column(
                ...
                children: [
                  DropdownButtonFormField<String>(
                    ...
                    items: EnumTranslations.getBadgeOptions(
                  ...
                  if (_selectedHaveBadge != 'عادي') ...[
                    ...
                    DropdownButtonFormField<int>(
                      ...
                      items: <int>[0, 1, 2, 3, 4, 5, 6, 7]
                          .where((int value) =>
                              _selectedHaveBadge == 'عادي' ? true : value != 0)
                    ...
                    Container(
                      ...
                      child: Text(
                        _language.tPointsDeductionText(_calculatedPoints,
                            _selectedHaveBadge, _selectedBadgeDuration),
                        style: const TextStyle(
          ...
          // Add premium post hint if a premium badge is selected
          if (_selectedHaveBadge != 'عادي')
            PremiumPostHint(
              selectedBadgeType: _selectedHaveBadge,
              userID: widget.userId, // Pass the user ID from your widget
            ),
        ],
      ),
    );
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      context.read<ServicePostBloc>().add(CreateServicePostEvent(
          servicePost: servicePost, imageFiles: imageFiles));
    } catch (e) {
        ...
        listener: (context, state) {
          if (state is ServicePostOperationSuccess) {
            ...
            if (state.errorMessage
                .contains(_language.tInsufficientBalanceText())) {
          ...
          children: [
            ...
            Expanded(
              child: PageView(
                ...
                children: _formSteps
                    .map((step) => step['content'] as Widget)
                    .toList(),
              ),
            ),
