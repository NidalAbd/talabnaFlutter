...
import 'package:talabna/screens/interaction_widget/email_tile.dart';
import 'package:talabna/screens/interaction_widget/phone_tile.dart';
import 'package:talabna/screens/interaction_widget/user_contact.dart';
import 'package:talabna/screens/interaction_widget/watsapp_tile.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        _buildSectionHeader(_language.getContactInformationText(),
            Icons.contact_page_outlined, primaryColor),
        _buildContactInfoCard(context),
        const SizedBox(height: 24),

        // Personal Details Section
        _buildSectionHeader(_language.getPersonalDetailsText(),
            Icons.person_outline_rounded, primaryColor),
        _buildPersonalDetailsSection(primaryColor, backgroundColor, textColor),
        const SizedBox(height: 24),

        // Additional Information Section
        _buildSectionHeader(_language.getAdditionalInformationText(),
            Icons.info_outline_rounded, primaryColor),
        _buildAdditionalInfoSection(primaryColor, backgroundColor, textColor),
      ],
    );
  }
...
// Replace the _getLocalizedGender method in the UserInfoWidget class
  ...
  Widget _buildPersonalDetailsSection(
      Color primaryColor, Color backgroundColor, Color textColor) {
    return Container(
      decoration: BoxDecoration(
        color: Theme.of(context).cardColor,
        borderRadius: BorderRadius.circular(16),
      ...
      child: Column(
        children: [
          ...
          _buildDetailTile(
            ...
            subtitle: widget.user.city?.getName(_language.getLanguage()) ??
          ...
          trailing: Container(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                fontWeight:
                    highlightSubtitle ? FontWeight.w500 : FontWeight.normal,
                fontSize: 14,
              ),
            ),
          ),
