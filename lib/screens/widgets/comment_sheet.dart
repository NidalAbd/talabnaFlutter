...
import 'package:talabna/blocs/comments/comment_state.dart';
...
import 'package:talabna/screens/widgets/user_avatar_profile.dart';
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      maxLines: 4,
                      // Allow multiple lines but with a limit
                      minLines: 1,
                  ...
                  IconButton(
                    ...
                    onPressed:
                        _isAdding || _commentController.text.trim().isEmpty
                            ? null
                            : _addComment,
                  ),
                ],
