...
class _AboutScreenState extends State<AboutScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content:
                Text(_language.getLanguage() == 'ar' ? 'خطأ: $e' : 'Error: $e'),
            backgroundColor: Colors.red,
          ),
        );
      }
  ...
  String _getFeatureDescription(int index) {
    ...
    if (currentLanguage == 'ar') {
      switch (index) {
        case 0:
          return 'تصفح الخدمات عبر الوظائف والعقارات والسيارات والأجهزة والمزيد';
        case 1:
          return 'قم بإنشاء وإدارة إعلاناتك بسرعة بنقرات قليلة فقط';
        case 2:
          return 'ابحث عما تريده بالضبط باستخدام خيارات البحث القوية';
        case 3:
          return 'تحدث مباشرة مع المشترين والبائعين لإتمام الصفقات';
        case 4:
          return 'استخدم التطبيق بلغتك المفضلة للحصول على تجربة مريحة';
        default:
          return '';
      }
    } else {
      switch (index) {
        case 0:
          return 'Browse services across jobs, real estate, cars, devices, and more';
        case 1:
          return 'Quickly create and manage your listings in just a few taps';
        case 2:
          return 'Find exactly what you\'re looking for with powerful search options';
        case 3:
          return 'Chat directly with buyers and sellers to finalize deals';
        case 4:
          return 'Use the app in your preferred language for a comfortable experience';
        default:
          return '';
      }
    }
                ...
                (context, index) {
                  ...
                  switch (index) {
                    case 0:
                      ...
                      break;
                    case 1:
                      featureIcon = Icons.post_add_rounded;
                      break;
                    case 2:
                    ...
                    case 3:
                      ...
                      break;
                    case 4:
                      featureIcon = Icons.language_rounded;
                      break;
                    default:
                      featureIcon = Icons.star_rounded;
                  }
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        _buildModernContactButton(
                          ...
                          onTap: () =>
                              _launchURL('https://www.talbna.com/support'),
                        ),
                      ],
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        _buildSocialButton(Icons.facebook_rounded,
                            () => _launchURL('https://facebook.com/talbna')),
                        const SizedBox(width: 16),
                        _buildSocialButton(Icons.phone_rounded,
                            () => _launchURL('tel:+1234567890')),
                        const SizedBox(width: 16),
                        _buildSocialButton(Icons.smartphone_rounded,
