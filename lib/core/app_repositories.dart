  ...
  static Future<AppRepositories> initialize() async {
    ...
    try {
      ...
      if (GetIt.instance.isRegistered<ServicePostRepository>() &&
        ...
        DebugLogger.log('Using repositories from service locator',
        ...
        DebugLogger.log('Service locator not ready, using direct instantiation',
            category: 'REPOSITORIES');
      ...
      DebugLogger.log('Error initializing repositories: $e',
          category: 'REPOSITORIES');
